...
d3.json("https://raw.githubusercontent.com/jkedzier/Mapping_Earthquakes/master/PB2002_boundaries.json").then(function(plate_data) {
  L.geoJson(plate_data).addTo(plates);
